...
# sources: https://github.com/tonylambiris/dotfiles/blob/master/dot.zshrc
...
export XDG_CONFIG_HOME=/home/jonas/.config
alias school='cd ~/Documents/Ugent/Bach/3/2'
alias ls='ls --color=auto'
alias drone='cd ~/git/integratieprojecten1718'
alias venvDocker='sudo docker run -it --device=/dev/ttyUSB0 -v `pwd`/:/esp/project registry.tymeli.be/micropython-esp32-builder'
alias ugesco='cd ~/Documents/ugesco'
alias get_esp32='export PATH="$PATH:$HOME/esp/xtensa-esp32-elf/bin"'
alias micropython='/home/jonas/Documents/Ugent/Bach/3/2/Integratie\ project/micropython/ports/unix/micropython'
alias anomalyapi='cd ~/Documents/Ugent/Stage/git/network-anomaly-api'
...
setup_agents() {
  # echo "Going to load the SSH and GPG agents"
  [[ $UID -eq 0 ]] && return
...
ZSH_THEME="powerlevel9k/powerlevel9k" # the powerlevel9k repo is cloned to /usr/share/zsh/
...
POWERLEVEL9K_SHORTEN_STRATEGY="truncate_left" #"truncate_to_first_and_last"
...
POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR="%F{$(( $DEFAULT_BACKGROUND - 4 ))}|%f"
POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR="\uE0B6"
POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR="%F{$(( $DEFAULT_BACKGROUND - 4 ))}|%f"

POWERLEVEL9K_PROMPT_ON_NEWLINE=true
POWERLEVEL9K_RPROMPT_ON_NEWLINE=false

POWERLEVEL9K_STATUS_VERBOSE=true
POWERLEVEL9K_STATUS_CROSS=false 	# shows the exit code
...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(virtualenv user root_indicator dir_writable dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(os_icon command_execution_time background_jobs status battery time ssh)
...
POWERLEVEL9K_USER_ICON="\uF109" # a computer
...
cowsay -f $(ls /usr/share/cows/ | shuf -n 1 | cut -d. -f1) $(whatis $(ls /bin) 2>/dev/null | shuf -n 1)
